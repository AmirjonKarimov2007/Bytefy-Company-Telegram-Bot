...
class BasicService(models.Model):
    id = 1
    service = models.OneToOneField(Service, on_delete=models.CASCADE, related_name='basic_service', null=True,
                                   blank=True)
...
class StandardService(models.Model):
    service = models.OneToOneField(Service, on_delete=models.CASCADE, related_name='standard_service', null=True,
                                   blank=True)
...
class PremiumService(models.Model):
    service = models.OneToOneField(Service, on_delete=models.CASCADE, related_name='premium_service', null=True,
                                   blank=True)
